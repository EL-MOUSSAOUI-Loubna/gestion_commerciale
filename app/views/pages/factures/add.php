    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
      <div class="payment-methods">
        ...
        <div class="d-flex flex-wrap gap-3 mt-1">
          ...
          <div class="form-check">
            <input class="form-check-input payment-method-checkbox border-secondary" type="checkbox" id="paiement-carte"
              value="carte">
            <label class="form-check-label" for="paiement-carte">Carte</label>
          </div>
          <div class="form-check">
            <input class="form-check-input payment-method-checkbox border-secondary" type="checkbox" id="paiement-effet"
              value="effet">
            <label class="form-check-label" for="paiement-effet">Effet</label>
          </div>
          <div class="form-check">
            <input class="form-check-input payment-method-checkbox border-secondary" type="checkbox" id="paiement-autre"
              value="autre"">
