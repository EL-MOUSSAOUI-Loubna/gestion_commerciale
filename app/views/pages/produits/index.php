...
<div class="container">
    ...
    <?php if (isset($_GET['success'])): ?>
        <div class="alert alert-success">
            <?php 
                switch($_GET['success']) {
                    case 'created': echo 'Produit ajouté avec succès.'; break;
                    case 'updated': echo 'Produit modifié avec succès.'; break;
    ...
    <?php if (isset($_GET['error'])): ?>
        <div class="alert alert-danger">
            <?php 
                switch($_GET['error']) {
                    case 'delete_failed': echo 'Erreur lors de la suppression du produit.'; break;
        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td class="d-flex">
                        <!-- Show button -->
                        <a href="/stage/produits/show?id=<?= $produit['id'] ?>" class="btn btn-info btn-sm me-1" title="Détails">
                            <i class="fas fa-eye"></i>
                        </a>
                        
                        <!-- Edit button -->
                        <a href="/stage/produits/edit?id=<?= $produit['id'] ?>" class="btn btn-warning btn-sm me-1" title="Modifier">
                            <i class="fas fa-edit"></i>
                        </a>
                        
                        <!-- Delete button (form with POST method) -->
                        <form method="post" action="/stage/produits/delete" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce produit?');">
