<?php // At the top of the form page (edit.php):
$_SESSION['csrf_token'] = bin2hex(random_bytes(32));
?>
<div class="container mt-5">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h1 class="h4 mb-0"><i class="fas fa-user-edit me-2"></i>Modifier client : <?= htmlspecialchars($client['nom_ste']) ?></h1>
        </div>
        
        <div class="card-body">
            <?php if (isset($_GET['error'])): ?>
                <div class="alert alert-danger alert-dismissible fade show">
                    <strong>Erreur!</strong> Lors de la modification du client.
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nom_ste" name="nom_ste" 
                               value="<?= htmlspecialchars($client['nom_ste'] ?? '') ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="ice" name="ice" 
                               value="<?= htmlspecialchars($client['ice'] ?? '') ?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="idf" name="idf" 
                               value="<?= htmlspecialchars($client['idf'] ?? '') ?>">
                    </div>
